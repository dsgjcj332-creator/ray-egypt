    ...
    <section className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <button 
          ...
          className="hidden sm:flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-ray-black dark:text-white px-5 py-2.5 rounded-full text-sm font-bold hover:bg-gray-50 dark:hover:bg-gray-700 transition shadow-sm"
        >
          تصفح الكل
      ...
      <div className="mt-8 sm:hidden">
        <button 
          onClick={() => onNavigate && onNavigate('categories')}
          className="flex items-center justify-center gap-2 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-ray-black dark:text-white px-5 py-3 rounded-xl text-sm font-bold hover:bg-gray-50 dark:hover:bg-gray-700 transition shadow-sm"
        >
          تصفح الكل
          <ArrowLeft className="w-4 h-4" />
        </button>
