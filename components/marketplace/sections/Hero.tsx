         ...
         <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
           ...
           <div className="text-center md:text-right max-w-2xl space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
                ...
                <button className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white font-bold text-lg rounded-xl hover:bg-white hover:text-ray-blue transition duration-300 w-full sm:w-auto active:scale-95">
                  اكتشف العروض
                </button>
              </div>
           </div>
