  ...
  return (
    <>
      ...
      <div className="relative bg-white pb-6">
        <div className="h-56 md:h-64 w-full bg-gray-200 overflow-hidden relative">
          <Image 
            src={heroImage} 
            alt="Cover"
            fill
        ...
        <div className="px-4 max-w-4xl mx-auto relative -mt-20 flex flex-col items-center text-center">
          <div className="w-28 h-28 bg-white rounded-3xl p-1.5 shadow-xl mb-3 rotate-3 hover:rotate-0 transition duration-500 relative z-10">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 md:gap-6 text-sm bg-gray-50 px-4 md:px-6 py-3 rounded-2xl border border-gray-100 shadow-sm">
